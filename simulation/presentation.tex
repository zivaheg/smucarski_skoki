...
\begin{frame}
  ...
  \begin{figure}
  \centering
      \includegraphics[width=0.5\linewidth]{ssm_shema.png}
...
\begin{frame}{Angles}
  ...
  \begin{figure}
  \centering
      \includegraphics[width=0.6\linewidth]{koti.png}
...
\begin{figure}
\centering
    \includegraphics[width=0.8\textwidth]{flight_simulation167.png}
