...
State Space Models (SSMs \cite{vanWieringen2015ridge}) are a family of machine learning algorithms designed to 
...
We also tried a hybrid approach combining SSM and Physics-informed Neural Networks (PINNs \cite{Cai2021_PINN_FluidMechanics}), where
