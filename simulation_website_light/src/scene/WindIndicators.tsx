...
const ZONES = [
  { x: 25, name: 'takeoff', label: 'Takeoff wind', color: '#27755a' },
  { x: 90, name: 'middle', label: 'Mid-flight wind', color: '#5276a6' },
  { x: 150, name: 'landing', label: 'Landing wind', color: '#d07b32' },
]
