...
export function LandingHill({ hill, showLabels }: LandingHillProps) {
  ...
  return (
    <group>
      ...
      <Line points={leftEdge} color="#6e8d7c" lineWidth={1.2} transparent opacity={0.72} />
      <Line points={centre} color="#789586" lineWidth={1.2} transparent opacity={0.58} />
      <Line points={rightEdge} color="#6e8d7c" lineWidth={1.2} transparent opacity={0.72} />
